...
public class zombieScript : MonoBehaviour {
	//declare the transform of our goal (where the navmesh agent will move towards) and our navmesh agent (our zombie)
	...
	// built in function, occurs when an object with rigidbody (bullet) collides with object that has a collider (zombie)
